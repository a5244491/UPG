...
public class PaymentInfo implements Serializable {
	...
	public Map<String, Object> toMap() {
		...
		resultMap.put("oid_partner", this.getOid_partner());
		resultMap.put("user_id", this.getUser_id());
		resultMap.put("sign_type", this.getSign_type());
		resultMap.put("busi_partner", this.getBusi_partner());
		resultMap.put("no_order", this.getNo_order());
		resultMap.put("dt_order", this.getDt_order());
		resultMap.put("name_goods", this.getName_goods());
		resultMap.put("info_order", this.getInfo_order());
		resultMap.put("money_order", this.getMoney_order());
		resultMap.put("notify_url", this.getNotify_url());
		resultMap.put("url_return", this.getUrl_return());
		resultMap.put("userreq_ip", this.getUserreq_ip());
		resultMap.put("url_order", this.getUrl_order());
		resultMap.put("valid_order", this.getValid_order());
		resultMap.put("timestamp", this.getTimestamp());
		resultMap.put("sign", this.getSign());
		resultMap.put("risk_item", this.getRisk_item());
...
//        req.setAttribute("back_url", paymentInfo.getBack_url());
		resultMap.put("req_url", ServerURLConfig.PAY_URL);
		return resultMap;
	}
